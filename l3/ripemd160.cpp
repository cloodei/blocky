...
inline uint8_t* ripemd100(uint8_t* input, size_t length) noexcept {
    return ripe100(input, length);
}

inline uint8_t* ripemd100(const string& input) noexcept {
    return ripe100((uint8_t*)input.data(), input.size());
}
...
inline uint8_t* ripemd160(uint8_t* input, size_t length) noexcept {
    return ripe160(input, length);
}

inline uint8_t* ripemd160(const string& input) noexcept {
    return ripe160((uint8_t*)input.data(), input.size());
}
